            ...
            if (frm.doc.status === "Pending") {
                ...
                frm.add_custom_button(__('Refuse Request'), function() {
                    frappe.confirm(
                        ...
                        function() {
                            frappe.call({
                                method: "onco.onco.onco.doctype.importation_approval_request.importation_approval_request.approve_request",
                                args: {
...
function create_importation_approval(frm) {
    frappe.model.open_mapped_doc({
        method: "onco.onco.onco.doctype.importation_approval_request.importation_approval_request.make_importation_approval",
        frm: frm
    });
}
...
function create_modification(frm) {
    ...
    let d = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            ...
            frappe.call({
                method: "onco.onco.onco.doctype.importation_approval_request.importation_approval_request.create_modification",
                args: {
...
function create_extension(frm) {
    ...
    let d = new frappe.ui.Dialog({
        ...
        primary_action: function(values) {
            ...
            frappe.call({
                method: "onco.onco.onco.doctype.importation_approval_request.importation_approval_request.create_extension",
                args: {
                    source_name: frm.doc.name,
